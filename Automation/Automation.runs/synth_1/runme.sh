...
HD_PWD='/home/vlsidesign3/Work_Saineeth/icdesignlab/Automation/Automation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_4BIT_ARRAY_MULTIPLIER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_4BIT_ARRAY_MULTIPLIER.tcl

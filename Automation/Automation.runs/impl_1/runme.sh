...
HD_PWD='/home/vlsidesign3/Work_Saineeth/icdesignlab/Automation/Automation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_4BIT_ARRAY_MULTIPLIER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_4BIT_ARRAY_MULTIPLIER.tcl -notrace
